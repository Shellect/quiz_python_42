...
Revision ID: 5fdf40a37c9d
Revises: 
Create Date: 2025-10-28 17:14:20.189707
...
def upgrade() -> None:
    ...
    op.create_table('users',
                    ...
                    sa.Column('is_admin', sa.BOOLEAN(), server_default=sa.text('false'), autoincrement=False,
                              nullable=True),
                    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'),
                              autoincrement=False, nullable=True),
